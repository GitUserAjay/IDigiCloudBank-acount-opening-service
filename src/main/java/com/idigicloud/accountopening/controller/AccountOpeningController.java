...
import com.idigicloud.accountopening.util.SecurityContextUtil;
...
@RequiredArgsConstructor                  // injects accountOpeningService + securityContextUtil via constructor
...
public class AccountOpeningController {
    ...
    /**
     * Resolves the DB user id from the JWT principal.
     * Uses the injected SecurityContextUtil bean (not a static call).
     */
    private Long resolveUserId(UserDetails userDetails) {
        return securityContextUtil.getCurrentUserId(userDetails);
    }
}
