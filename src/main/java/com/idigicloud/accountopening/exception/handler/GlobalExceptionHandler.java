package com.idigicloud.accountopening.exception.handler;
...
import com.idigicloud.accountopening.exception.*;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(CbsServiceException.class)
    public ResponseEntity<ApiResponse<Void>> handleCbsError(CbsServiceException ex) {
        log.error("CBS service error: {}", ex.getMessage());
        return ResponseEntity.status(HttpStatus.SERVICE_UNAVAILABLE)
                .body(ApiResponse.failure("CBS Service Error: " + ex.getMessage()));
    }
